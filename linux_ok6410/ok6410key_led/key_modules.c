...
#include <mach/regs-gpio.h>
//#include<mach/gpio_fns.h>
#include <plat/gpio-cfg.h>
#include <mach/gpio-bank-n.h>
#include <mach/regs-clock.h>
//#include <mach/gpio-bank-l.h>

#define DEVICE_NAME     "keyset"
...
//static unsigned long led_table[]={S3C64XX_GPM0,S3C64XX_GPM1,S3C64XX_GPM2,S3C64XX_GPM3};
//static unsigned int led_cfg_table[]={S3C_GPIO_SFN(1),S3C_GPIO_SFN(1),S3C_GPIO_SFN(1),S3C_GPIO_SFN(1)};
...
static int s3c64xx_leds_ioctl(struct file *file,unsigned int cmd,unsigned long arg)
{
	switch(cmd) {
			case 0:
			case 1:
		...
		gpio_direction_output(S3C64XX_GPM(arg), !cmd);
		return 0;
		default:
		return -EINVAL;
	}
...
static struct file_operations dev_fops = {
    ...
    .unlocked_ioctl=s3c64xx_leds_ioctl,   
};
...
unsigned i;
 ...
 printk (DEVICE_NAME"\tinitialized\n");
   for (i = 0; i < 4; i++)                    //在初始化设备驱动的时候，初始化led，管脚设为输出，且熄灭led
   {
       s3c_gpio_cfgpin(S3C64XX_GPM(i),S3C_GPIO_SFN(1));
       gpio_direction_output(S3C64XX_GPM(i), 1);
   }
